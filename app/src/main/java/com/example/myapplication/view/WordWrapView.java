...
public class WordWrapView extends ViewGroup {
    private static final int PADDING_HOR = 15;//子view水平方向padding
    private static final int PADDING_VERTICAL = 20;//子view垂直方向padding
    private static int TEXT_MARGIN_HOR = 0;//子view之间的水平间距
    private static final int TEXT_MARGIN_VERTICAL = 30;//行间距
    ...
    public WordWrapView(Context context) {
        super(context);
        TEXT_MARGIN_HOR = Utils.dip2px(context, 7);
    }
